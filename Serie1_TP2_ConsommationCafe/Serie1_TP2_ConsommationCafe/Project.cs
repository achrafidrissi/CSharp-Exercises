...
namespace Serie1_TP2_ConsommationCafe
{
    internal class Project
    {
        ...
        public List<CoffeeConsumption> Consommations { get; private set; }
        ...
        public Project(string code, string sujet, int duree)
        {
            ...
            Consommations = new List<CoffeeConsumption>();
        }
        ...
        public void AjouterConsommation(int semaine, int idProgrammeur, int nbTasses)
        {
            ...
            if (prog != null)
            {
                Consommations.Add(new CoffeeConsumption(semaine, prog, nbTasses));
            }
        }
